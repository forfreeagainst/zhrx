...
export default defineConfig4CustomTheme({
  ...
  themeConfig: {
    ...
    repo: 'forfreeagainst/zhrx',
    searchMaxSuggestions: 10,
    docsDir: 'docs',
    footer: {
      createYear: 2023,
      copyrightInfo:
        'encode studio | <a href="https://github.com/forfreeagainst/zhrx" target="_blank">github</a>',
    },
    extendFrontmatter: {
      author: {
        name: 'durant',
        link: 'https://github.com/forfreeagainst/zhrx',
      },
    },
  },
  head: [
